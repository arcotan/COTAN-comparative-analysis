...
minNumClusterAntibody = numClusterAntibody - numClusterThreshold*numClusterAntibody
maxNumClusterAntibody = numClusterAntibody - numClusterThreshold+numClusterAntibody
...
PBMC <- readRDS(file = file.path(outDir, paste0(datasetName, ".cotan.RDS")))
```
...
repeat{
  ...
  numClusters = nrows(table(antibodyClusters))
  cat(paste("Got ", numClusters, ' clusters', sep=''))
